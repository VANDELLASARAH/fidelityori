//Added to make HTML5 default runtime
				var node = document.createElement("meta");
                node.setAttribute("name","tp:preferredRuntimes");
               node.setAttribute("content","HTML5,Flash");
                document.getElementsByTagName('head')[0].appendChild(node); 
//HTML5 default runtime Addition Ends
